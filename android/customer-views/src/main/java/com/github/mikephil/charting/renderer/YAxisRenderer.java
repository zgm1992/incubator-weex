...
public class YAxisRenderer extends AxisRenderer {
    ...
    protected void drawYLabels(Canvas c, float fixedPosition, float[] positions, float offset) {
        ...
        for (int i = from; i < to; i++) {
            ...
            if (i == 0) {
                if (mYAxis.mEntries[0] < 0) {
                    valueOffset = Math.abs(mYAxis.mEntries[0]);
                }
            }
            mYAxis.setCurrentLabelIndex(i);
            String text = mYAxis.getFormattedLabel(i, valueOffset);
            if (!TextUtils.isEmpty( mYAxis.getUnitLabel()) && !TextUtils.isEmpty(text)){
                text = text + mYAxis.getUnitLabel();
            }
    ...
    public void renderGridLines(Canvas c) {
        ...
        if (mYAxis.isDrawGridLinesEnabled()) {
            ...
            mGridPaint.setAlpha((int) (255*mYAxis.getGridAlpha()));
            ...
            int i = 0;
            if (mYAxis.isIgnoreFirstDrawGridLines()){
                i = 2;
            }
            // draw the grid
