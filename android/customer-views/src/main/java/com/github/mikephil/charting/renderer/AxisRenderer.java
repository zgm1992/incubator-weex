...
public abstract class AxisRenderer extends Renderer {
    ...
    protected Paint mAxisSignPostLinePaint;
    ...
    public AxisRenderer(ViewPortHandler viewPortHandler, Transformer trans, AxisBase axis) {
        ...
        if(mViewPortHandler != null) {
            ...
            mAxisSignPostLinePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
            mAxisSignPostLinePaint.setStyle(Style.FILL_AND_STROKE);
    ...
    protected void computeAxisValues(float min, float max) {
        ...
        if (mAxis.isCenterAxisLabelsEnabled()) {
            ...
            float offset = (float)interval / 4f;

            for (int i = 0; i < n; i++) {
                mAxis.mCenteredEntries[i] = mAxis.mEntries[i] + offset;
            }
            currentOffset = (float) interval;
        }
    }
