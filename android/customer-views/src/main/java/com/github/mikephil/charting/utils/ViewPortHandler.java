...
public class ViewPortHandler {
    ...
    protected int maxHighLightColor = 0;
    ...
    public void setMaxHighLightColor(int maxHighLightColor) {
    ...
    public int getInterceptTop() {
        return interceptTop;
    }

    public void setInterceptTop(int interceptTop) {
     ...
     * @return
     */
    public Matrix refreshXScale(Matrix newMatrix, float xScale, View chart, boolean invalidate) {
        this.xScale =  xScale;
        return refresh(newMatrix,chart,invalidate);
    }
    /**
     * call this method to refresh the graph with a given matrix
     *
    ...
    public void limitTransAndScale(Matrix matrix, RectF content) {
        ...
        if (mScaleX != this.xScale) {
            mScaleX  = this.xScale;
            mTransX = 0.0f;
            Log.e("limitTransAndScale", "计算 出错，重置页面");
        }
    ...
    SignPostRender signPostRender = new SignPostRender();

    public SignPostRender getSignPostRender() {
        return signPostRender;
    }

    public void setSignPostRender(SignPostRender signPostRender) {
        this.signPostRender = signPostRender;
    }
