...
public class ChartHighlighter<T extends BarLineScatterCandleBubbleDataProvider> implements IHighlighter
{
    ...
    public float realX = -1;
    public float realY = -1;
    ...
    protected List<Highlight> getHighlightsAtXValue(float xVal, float x, float y) {
        ...
        for (int i = 0, dataSetCount = data.getDataSetCount(); i < dataSetCount; i++) {
            ...
            if (!(dataSet.isHighlightEnabled() || dataSet.isSignalEnabled()))
                continue;
            mHighlightBuffer.addAll(buildHighlights(dataSet, i, xVal,x,y, DataSet.Rounding.CLOSEST));
        }
     ...
     * @return
     */
    protected List<Highlight> buildHighlights(IDataSet set, int dataSetIndex, float xVal, float x, float y, DataSet.Rounding rounding) {
