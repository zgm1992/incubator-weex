...
public class BarDataSet extends BarLineScatterCandleBubbleDataSet<BarEntry> implements IBarDataSet {
    ...
    MChartBean.SignPost signPost = null;
    int maxHighLightColor = 0;
    boolean isSignalEnable = false;
    /**
    ...
    private List<String> mBorderType = new ArrayList<>();
    /**
    ...
    public void setBorderType(List<String> mBorderType) {
