...
public abstract class AxisBase extends ComponentBase {
    ...
    protected boolean mIsIgnoreFirstDrawGridLines = true;
    ...
    private boolean isShowSignPost = false;


    private int signPostLineMarginTop  = 20;

    private int signPostLineMarginBottom  = 20;

    private int signPostLinePointRadius  = 10;

    private int signPostLineColor = Color.BLACK;
    ...
    public boolean isShowSignPost() {
        return isShowSignPost;
    }

    public void setShowSignPost(boolean showSignPost) {
        isShowSignPost = showSignPost;
    }

    public int getSignPostLineMarginTop() {
        return signPostLineMarginTop;
    }

    public void setSignPostLineMarginTop(int signPostLineMarginTop) {
        this.signPostLineMarginTop = signPostLineMarginTop;
    }

    public int getSignPostLineMarginBottom() {
        return signPostLineMarginBottom;
    }

    public void setSignPostLineMarginBottom(int signPostLineMarginBottom) {
        this.signPostLineMarginBottom = signPostLineMarginBottom;
    }

    public int getSignPostLineColor() {
        return signPostLineColor;
    }

    public void setSignPostLineColor(int signPostLineColor) {
        this.signPostLineColor = signPostLineColor;
    }

    public int getSignPostLinePointRadius() {
        return signPostLinePointRadius;
    }

    public void setSignPostLinePointRadius(int signPostLinePointRadius) {
        this.signPostLinePointRadius = signPostLinePointRadius;
    }

    private boolean isFirstOverZero = false;
    public boolean isFirstOverZero() {
        return isFirstOverZero;
    }

    public void setIsFirstOverZero(boolean isFirstOverZero) {
        this.isFirstOverZero = isFirstOverZero;
    }
    ...
    public boolean isIgnoreFirstDrawGridLines() {
        return mIsIgnoreFirstDrawGridLines;
    }

    public void setIsIgnoreFirstDrawGridLines(boolean isIgnoreFirstDrawGridLines) {
        this.mIsIgnoreFirstDrawGridLines = isIgnoreFirstDrawGridLines;
    }
    ...
    public void setGridAlpha(float mGridAlpha) {
        this.mGridAlpha = mGridAlpha;
    }
    ...
    public String getFormattedLabel(int index, float valueOffset) {

        if (index < 0 || index >= mEntries.length)
            return "";
        else
            return getValueFormatter().getFormattedValue(mEntries[index]+valueOffset, this);
    }
    ...
    TouchType touchType = TouchType.Default;
