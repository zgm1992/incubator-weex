...
public class YAxis extends AxisBase {
    ...
    public void setCurrentLabelIndex(int currentLabelIndex) {
    ...
    public void calculate(float dataMin, float dataMax) {
        ...
        if (getTouchType()==TouchType.notShowValue){
            this.mAxisMaximum = dataMax;
        } else if (getTouchType() == TouchType.ShowValue){
            this.mAxisMaximum = (dataMax + topSpace);
        } else {
