...
public abstract class ComponentBase {
    ...
    protected int mBoldTextColor = -1;

    protected boolean isBoldText = false;
...
//        mYOffset = Utils.convertDpToPixel(yOffset);
    ...
    public void setBoldTextColor(int color) {
        mBoldTextColor = color;
    }

    public int getBoldTextColor() {
        return mBoldTextColor;
    }
    ...
    public void setIsBoldText(boolean boldText) {
        isBoldText = boldText;
    }
