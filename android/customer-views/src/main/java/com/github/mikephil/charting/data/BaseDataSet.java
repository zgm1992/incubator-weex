...
public abstract class BaseDataSet<T extends Entry> implements IDataSet<T> {
    ...
    protected List<Integer> mMaxColors = null;
    ...
    public BaseDataSet() {
        ...
        mMaxColors = new ArrayList<Integer>();
        mValueColors = new ArrayList<Integer>();

        // default color
        mColors.add(Color.rgb(140, 234, 255));
        mMaxColors.add(Color.rgb(140, 234, 255));
    ...
    @Override
    public List<Integer> getMaxColors() {
        return mColors;
    }
