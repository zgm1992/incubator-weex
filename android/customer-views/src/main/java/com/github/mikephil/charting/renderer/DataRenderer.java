...
public abstract class DataRenderer extends Renderer {
    ...
    protected Paint mMaxValuePaint;
    ...
    protected Paint mMaxHighlightPaint;
    ...
    public DataRenderer(ChartAnimator animator, ViewPortHandler viewPortHandler) {
        ...
        mRenderPaint.setStrokeWidth(15);
        mRenderPaint.setStyle(Style.FILL);

        mMaxValuePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mMaxValuePaint.setStyle(Style.FILL);
        ...
        mHighlightPaint.setStyle(Style.FILL_AND_STROKE);
        mHighlightPaint.setStrokeWidth(2f);

        mMaxHighlightPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mMaxHighlightPaint.setStyle(Style.FILL_AND_STROKE);
        mMaxHighlightPaint.setStrokeWidth(2f);

        mCursorPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mCursorPaint.setStyle(Style.FILL_AND_STROKE);
        mCursorPaint.setStrokeWidth(2f);
        mCursorPaint.setColor(Color.rgb(255, 187, 115));
    }
