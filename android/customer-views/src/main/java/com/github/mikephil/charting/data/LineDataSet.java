...
public class LineDataSet extends LineRadarDataSet<Entry> implements ILineDataSet {
    ...
    private boolean mDrawHighlightCircles = true;


    private int highLightCircleColor =  Color.BLACK;
    private int highLightCircleRadius = 8;

    private int highLightCircleHoleColor =  Color.WHITE;;
    private int  highLightCircleHoleRadius = 4;

    private int highLightCircleOutsideColor =  Color.BLACK;;
    private int highLightCircleOutsideWidth = 2;
    ...
    protected void copy(LineDataSet lineDataSet) {
        ...
        lineDataSet.mDrawHighlightCircles = mDrawHighlightCircles;
    ...
    public void setHighLightCircleRadius(int highLightCircleRadius) {
        this.highLightCircleRadius = (int) Utils.convertDpToPixel(highLightCircleRadius);
    }

    public int getHighLightCircleHoleColor() {
        return highLightCircleHoleColor;
    }

    public void setHighLightCircleHoleColor(int highLightCircleHoleColor) {
    ...
    public void setHighLightCircleHoleRadius(int highLightCircleHoleRadius) {
        this.highLightCircleHoleRadius = (int) Utils.convertDpToPixel(highLightCircleHoleRadius);
    }

    public int getHighLightCircleOutsideColor() {
        return highLightCircleOutsideColor;
    }

    public void setHighLightCircleOutsideColor(int highLightCircleOutsideColor) {
    ...
    public void setHighLightCircleOutsideWidth(int highLightCircleOutsideWidth) {
        this.highLightCircleOutsideWidth = (int) Utils.convertDpToPixel(highLightCircleOutsideWidth);
    }
    ...
    public boolean isDrawHighlightCircles() {
        return mDrawHighlightCircles;
    }

    public void setDrawHighlightCircles(boolean mDrawHighlightCircles) {
        this.mDrawHighlightCircles = mDrawHighlightCircles;
    }
    ...
    @Override
    public int getMaxHighLightColor() {
        return 0;
    }
