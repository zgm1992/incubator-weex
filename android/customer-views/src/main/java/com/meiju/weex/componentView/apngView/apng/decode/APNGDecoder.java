...
import com.meiju.weex.componentView.apngView.apng.io.APNGWriter;
...
public class APNGDecoder extends FrameSeqDecoder<APNGReader, APNGWriter> {
    ...
    public void getSelectFrame(int index, String next) {
        frameIndex = index;
        snapShot.dispose_op = FCTLChunk.APNG_DISPOSE_OP_BACKGROUND;
